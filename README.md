...
Across roughly 4,000 daily observations from January 2008 to December 2024, the nine NSE sectoral indices form a tightly integrated system, with a total connectedness index of about 54% under the static VAR and 55% on average under the TVP-VAR, rising as high as ~72% during crisis episodes and never falling below ~43%. The spillovers are, however, almost entirely an intra-equity phenomenon: the financial complex dominates transmission, with Financial Services (NET +16.7) and Banking (+13.7) the largest net exporters of shocks, followed by Auto (+9.3), Metals (+4.5) and Energy (+3.5), while the defensive sectors — Pharma (−13.8), IT (−12.6), FMCG (−10.3) and Media (−8.9) — are consistent net receivers. Strikingly, the three global oil structural shocks (demand, supply, risk) sit at the periphery of this network: they exchange very little with the equity sectors (each receiving only ~1–8% of its forecast-error variance from the rest of the system in the static model), and their net positions are essentially neutral (demand +0.8, supply +1.0, risk −3.9). The evidence therefore indicates that Indian sectoral return connectedness is driven overwhelmingly by domestic financial-sector transmission rather than by oil market shocks, which — contrary to the framing of oil shocks as "key driving variables" — appear largely disconnected from the sectoral spillover network over this sample.
